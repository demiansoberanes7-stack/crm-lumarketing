...
const HELP: Record<Source, { title: string; items: string[] }> = {
  ...
  meta: {
    ...
    items: [
      "El IG_USER_ID es el ID de Instagram del perfil profesional vinculado a tu página de Facebook.",
      "Genera ahí el token con los permisos instagram_basic, instagram_manage_messages y instagram_manage_comments.",
      "Sin App Review, solo recibes mensajes de cuentas con un rol en la app (administradores, desarrolladores, testers).",
    ],
  },
};
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            Messenger, con su distintivo de canal. {help.title}.
          </CardDescription>
        </CardHeader>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder={source === "zernio" ? "sk_…" : "IGQVJ…"}
                autoComplete="off"
              />
            </div>
            {source === "zernio" && (
